...
<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="max-w-4xl mx-auto bg-white border border-gray-300 p-8">
      <h1 class="text-xl font-normal text-gray-700 mb-8">자유게시판 글쓰기</h1>
      ...
      <div class="space-y-6">
        ...
        <div class="flex justify-end space-x-3 pt-4">
          <NuxtLink to="/free" class="px-6 py-2 border border-gray-300 text-sm text-gray-600 hover:bg-gray-50">취소</NuxtLink>
